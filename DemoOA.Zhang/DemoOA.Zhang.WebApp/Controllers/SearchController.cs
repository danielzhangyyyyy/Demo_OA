...
using DemoOA.Zhang.WebApp.Models;
...
namespace DemoOA.Zhang.WebApp.Controllers
{
    public class SearchController : Controller
    {
        ...
        private void CreateSerachContent()
        {
            ...
            //    //如果索引目录被锁定（比如索引过程中程序异常退出），则首先解锁（提示：如果我现在正在写着已经加锁了，但是还没有写完，这时候又来一个请求，那么不就解锁了吗？put this later）
